...
expedita consequatur consequatur dolores quia eos et placeat`}],tm=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsxs("strong",{className:"CommentInfo__name",children:[" ",e.name," "]})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.name})]}),j.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>e.length>0?j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Lc,{comment:t},t.id))}):j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}),Mc=({post:e,users:t})=>{const i=t.find(a=>a.id===e.userId),n=tm.filter(a=>a.postId===e.id);return j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:e.title}),j.jsxs("p",{children:[" Posted by  ",i?j.jsx(Pc,{user:i}):j.jsx("span",{children:"Unknown User"})]})]}),j.jsxs("p",{className:"PostInfo__body",children:[e.body,";"]}),j.jsx("hr",{}),j.jsx(Tc,{comments:n})]})},Rc=({posts:e,users:t,comments:i})=>j.jsx("div",{className:"PostList",children:e.map(n=>j.jsx(Mc,{post:n,users:t,comments:i},n.id))}),Dc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Rc,{posts:zc,users:Nc,comments:tm})]});em(document.getElementById("root")).render(j.jsx(Dc,{}));
